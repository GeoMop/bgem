...
class Region():
    # Description of a disjunctive geometry area sorted by dimension (dim=1 well, dim=2 fracture, dim=3 bulk)
...
class GeoLayer():
    ...
    def __init__(self):
        ...
        # self.top = None
        """According to the topology type, set the interface nodes or the interpolated node set."""
...
class StratumLayer(GeoLayer):
    ...
    def make_vert_bw_surface(self, top_edges, bot_edges, edge_start, edge_end):
        """
        Make vertical surface from set of 4 boundary edges.
...
class LayerGeometry():
    ...
    def init(self):
        ...
        # initialize layers, neighbouring layers refer to a common interface
    ...
    def construct_brep_geometry(self):
        ...
        4. for 2d layer:
                for every region:
                    make compound of subdivision BREP shapes
        ...
        # self.extruded_edges = {}    # (layer_id, node_id) : bw.Edge, oriented upward, Local to Layer
    ...
    def call_gmsh(self, mesh_step):
        ...
        with open(self.geo_file, "w") as f:
            ...
            # It sets an internal mesh option variable 'randFactor' which influences SOME meshing algorithms.
            #
