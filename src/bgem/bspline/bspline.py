...
class SplineBasis:
    ...
    - Optimize eval and eval_diff - without recursion, based on combinatorGeneralize optimized evaluation of eval_vector
     (If scipy is not faster)
    """
    ...
    def _eval_diff_vector_deg_2(self, i_int, t):
        ...
        :param i_int: Interval in which 't' belongs. Derivatives of the 3 nonzero basis functions on this
...
class Curve:
    ...
    def eval_local(self, t, it):
        """
        Evaluate a B-spline curve for parameter 't' with a given knot interval 'it'.
...
class Surface:
    ...
    def eval_local(self, u, v, iu, iv):
        """
        Evaluate a B-spline surface for parameters u,v with given knot subintervals.
    ...
    def eval(self, u, v):
        """
        Evaluate a B-spline surface for parameters u,v. Check and fix range of 'u, v'.
        :param u, v: Evaluation point.
        :return: D-dimensional numpy array. D - is dimension given by dimension of poles.
        TODO:
        - test evaluation for rational curves
...
class GridSurface:
    ...
    """
    # TODO: calling transform lose mapping between original point grid and unit square, approximation can't be performed
