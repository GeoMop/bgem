...
from bgem.src.bgem.bspline.surface_point_set import SurfacePointSet
from bgem.src.bgem import tools
...
class SurfaceApprox:
    ...
    def compute_approximation(self, **kwargs):
        ...
        while True:  # Adaptivity loop
            ...
            # #reg_coef = diff.dot(diff) / z_vec.dot(a_mat.dot(z_vec)) # should be replaced by a more stable formula
            #
    ...
    def _compute_default_nuv(self):
        ...
        # try to make number of unknowns less than number of remaining points
