import numpy as np
from bgem.src.bgem.stochastic import isec_conflict as IC
...
class FracIsec:
    ...
    def _get_points(self, tol):
        ...
        self.have_collision = len(points_A) + len(points_B) > 0 or min([0.0, *conflict.AB_dist, *conflict.BA_dist]) < tol
