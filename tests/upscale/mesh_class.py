...
from bgem.src.bgem.gmsh import heal_mesh
from bgem.src.bgem.core import File, report
...
class Mesh:
    ...
    def fr_map(self, dfn: 'FractureSet', reg_id_to_fr: Dict[str, int]):
        ...
        - alternative could be based on functional approach that would allow mapping shape IDs back to shapes
          and then shapes (including fractures), may be associated with various attributes
