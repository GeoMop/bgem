...
class SurfApprox:
    ...
    def surf_app(self):
        self.approx = bsa.SurfaceApprox.approx_from_file("/home/jiri/Github/real_data/grid_50_m.csv",file_delimiter=",")
...
class TestAdapt:
    ...
    def test_surface_intersection(self):
        ...
        #myplot.scatter_3d(app._xy_points[:, 0], app._xy_points[:, 1], app._z_points) points
        myplot.show() # view
