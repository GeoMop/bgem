...
from bgem.src.bgem.bspline.surface_point_set import scale_relative, SurfacePointSet
from bgem.tests.bspline.test_adapt import SurfApprox
...
class TestSurfaceApprox:
    ...
    def test_analytical(self, points_fn, z_fn, noise, adapt_tol):
        ...
        Linf is also unable to achieve target tolerance on validation pointset. Regularization needed as there are
